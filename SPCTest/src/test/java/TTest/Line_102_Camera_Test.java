...
public class Line_102_Camera_Test extends Base {
    ...
    public void line_102_APL_Camera_Success() throws InterruptedException{
        ...
        try {
            ...
            Assert.assertEquals(home_page_title, "SPC Data" ); // SPC main sayfasý gelmiyorsa fail olsun
            ...
            for ( int tab = 0;  tab< main.Tabs().size(); tab++)
            {
                ...
                if(graph_count==0){
                    ...
                    softassert.fail(text_tab + " No Data"); // tabta hiç bir grafik yoksa fail oluyor.
                }
